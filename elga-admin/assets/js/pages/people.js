/* ====================================================================
   KetdikGo Admin — Foydalanuvchilar bo'limi
   ==================================================================== */
(function(){
  var U = window.UI;
  ...
  function driversFleet(ctx){
    return window.listPage({
      title:'Avtopark', sub:'Park raqamlari · tom belgisi «KetdikGo 1226 + park raqami»',
      ...
      columns:[
        ...
        {th:'Tom belgisi', render:function(d){return '<span class="mono muted">KetdikGo 1226 · '+d.park_number+'</span>';}},
