/* ====================================================================
   KetdikGo Admin — Mock ma'lumotlar bazasi
...
(function(){
  ...
  var rewards = [
    ...
    {id:'RW4', title:'KetdikGo termo-stakan', desc:'Brendlangan termo-stakan sovg\'asi.', cost:1500, type:'gift', stock:40, active:true, icon:'gift'},
